...
namespace Modules\Academic\Http\Controllers\Leave;
...
class ManageController extends Controller
{
	...
	public function index(Request $request)
	{
		...
		return view('academic::leave.manage.index', compact('user', 'leaves', 'pending_leaves_count'));
	}
	...
	public function show(BoardingStudentsLeave $leave, Request $request)
	{
		...
		return view('academic::leave.manage.show', compact('user', 'student', 'employee', 'leave', 'results', 'parentBoard'));
	}
