...
class AcademicClassroom extends Model
{
    ...
    public function room () {
        return $this->belongsTo(\Modules\Administration\Models\SchoolBuildingRoom::class, 'room_id')->withDefault();
    }
    ...
    public function supervisor () {
        return $this->belongsTo(\Modules\HRMS\Models\Employee::class, 'supervisor_id')->withDefault();
    }
