...
class StudentSemester extends Model
{
    ...
    /**
     * This hasMany reports evaluation.
     */
    public function reportEval(){
        return $this->hasMany(StudentAcademicEvaluation::class, 'smt_id');
    }
    ...
    public function extras () {
        return $this->hasMany(StudentExtras::class, 'smt_id');
    }
}
