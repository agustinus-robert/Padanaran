...
@section('body-content')
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
        ...
        <aside id="side-overlay">
            <!-- Side Header -->
            <div class="bg-image" style="background-image: url({{ asset('backendPos/media/various/bg_side_overlay_header.jpg') }});">
                <div class="bg-primary-op">
                    <div class="content-header">
                        <!-- User Avatar -->
                        <a class="img-link me-1" href="be_pages_generic_profile.html">
                            <img class="img-avatar img-avatar48" src="{{ asset('backendPos/media/avatars/avatar10.jpg') }}" alt="">
                        </a>
                        <!-- END User Avatar -->

                        <!-- User Info -->
                        <div class="ms-2">
                            <a class="fw-semibold text-white" href="be_pages_generic_profile.html">George Taylor</a>
            ...
            <div class="content-side">
                <!-- Side Overlay Tabs -->
                @include('poz::layout.components.nvright')
        ...
        <nav id="sidebar" aria-label="Main Navigation">
            ...
            <div class="bg-header-dark">
                <div class="content-header bg-white-5">
                    <!-- Logo -->
                    <a class="fw-semibold tracking-wide text-white" href="index.html">
                        <span class="smini-visible">
                            D<span class="opacity-75">x</span>
                        </span>
                        <span class="smini-hidden">
                            Point Of <span class="opacity-75">Sale</span>
                        </span>
                    </a>
                    <!-- END Logo -->
            ...
            <div class="content-header">
                ...
                <div class="space-x-1">
                    ...
                    <button type="button" class="btn btn-alt-secondary" data-toggle="layout" data-action="header_search_on">
                        <i class="fa fa-fw fa-search opacity-50"></i> <span class="d-none d-sm-inline-block ms-1">Search</span>
                    </button>
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-lg rounded-0 p-0" aria-labelledby="page-header-shortcuts-dropdown">
                            <div class="bg-image" style="background-image: url('assets/media/photos/photo22.jpg');">
                                <div class="bg-primary-op fw-semibold px-3 py-4 text-center text-white">
                                    <div class="fs-4">
                                        Daftar Outlet
                                    </div>
                                    <div class="fs-6 fw-normal text-white-75">
                                        Silahkan Cek Outlet Anda
                                    </div>
                                </div>
                            </div>
                            <div class="row g-0 bg-body-extra-light push">
                                <div class="col-6">
                                    <a class="block-transparent block-link-pop mb-0 block text-center" href="javascript:void(0)">
