...
@php
    $limit = 3;
    $offset = 0;
    $blogs = blog_data($limit, $offset);
    $total = blog_total();
@endphp

<div data-num="1" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/a01.png') }}" data-cat="1">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title1-96 is-title-lite size-96">Lorem Ipsum</h1>
        </div>
    </div>
</div>

<div data-num="2" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/a02.png') }}" data-cat="1">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title1-64 is-title-lite size-64">Lorem Ipsum</h1>
        </div>
    </div>
</div>

<div data-num="3" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/a03.png') }}" data-cat="1">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title1-48 is-title-lite size-48">Lorem Ipsum</h1>
        </div>
    </div>
</div>

<div data-num="4" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/a04.png') }}" data-cat="1">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title1-48 is-title-lite is-upper size-48">Lorem Ipsum is simply dummy text</h1>
        </div>
    </div>
</div>

<div data-num="5" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/a05.png') }}" data-cat="1">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title1-32 is-title-lite is-upper size-32">Lorem Ipsum is simply dummy text of the printing and typesetting industry</h1>
        </div>
    </div>
</div>

<div data-num="6" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/a06.png') }}" data-cat="1">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title1-96 is-title-bold size-96">Lorem Ipsum</h1>
        </div>
    </div>
</div>

<div data-num="7" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/a07.png') }}" data-cat="1">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title1-64 is-title-bold size-64">Lorem Ipsum</h1>
        </div>
    </div>
</div>

<div data-num="8" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/a08.png') }}" data-cat="1">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title1-48 is-title-bold size-48">Lorem Ipsum</h1>
        </div>
    </div>
</div>

<div data-num="9" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/a09.png') }}" data-cat="0,1">
    <div class="row">
        <div class="col-md-12">
            <div class="display">
                <h1 class="is-title1-48 is-title-bold is-upper size-48">Lorem Ipsum is simply dummy text of the printing industry</h1>
            </div>
        </div>
    </div>
</div>

<div data-num="10" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/a10.png') }}" data-cat="1">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title1-32 is-title-bold is-upper size-32">Lorem Ipsum is simply dummy text of the printing and typesetting industry</h1>
        </div>
    </div>
</div>
...
<div data-num="11" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/c01.png') }}" data-cat="0">
...
<div data-num="12" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/g01.png') }}" data-cat="0,6">
...
<div data-num="13" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/e01.png') }}" data-cat="0,5">
...
<div data-num="14" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/e02.png') }}" data-cat="0,5">
...
<div data-num="15" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/e09.png') }}" data-cat="0,5">
...
<div data-num="16" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/v01.png') }}" data-cat="0,19">
...
<div data-num="17" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/v02.png') }}" data-cat="0,19">
...
<div data-num="18" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/b01.png') }}" data-cat="0">

    <div class="row">

        <div class="col-md-12">
            <div class="display">
                <h1 class="is-title1-48 is-title-bold is-upper size-48">Beautiful Content. Responsive.</h1>
...
<div data-num="19" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/b12.png') }}" data-cat="0">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="center">
                ...
                <img src="assets/minimalist-basic/b12-1.jpg" style="border-radius:500px">
...
<div data-num="20" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/b14.png') }}" data-cat="0">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="center">
                ...
                <img src="{{ asset('bstrapper/assets/minimalist-basic/b14-1.jpg') }}"><img src="{{ asset('bstrapper/assets/minimalist-basic/b14-2.jpg') }}"><img src="{{ asset('bstrapper/assets/minimalist-basic/b14-3.jpg') }}">
...
<div data-num="21" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/g02.png') }}" data-cat="0,6">

    <div class="row">

        <div class="col-md-6">

            <img src="assets/minimalist-basic/g02-1.jpg">
...
<div data-num="22" data-thumb="assets/minimalist-basic/thumbnails/g03.png" data-cat="0,6">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <img src="assets/minimalist-basic/g03-1.jpg">
...
<div data-num="23" data-thumb="assets/minimalist-basic/thumbnails/h01.png" data-cat="0,6">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <img src="assets/minimalist-basic/h01-1.jpg" style="border-radius:500px;margin-right: 1.5em">

            <img src="assets/minimalist-basic/h01-2.jpg" style="border-radius:500px;margin-right: 1.5em">

            <img src="assets/minimalist-basic/h01-3.jpg" style="border-radius:500px">
...
<div data-num="24" data-thumb="assets/minimalist-basic/thumbnails/h02.png" data-cat="0,6">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <img src="assets/minimalist-basic/h02-1.jpg" style="border-radius:500px;margin-right: 1.5em">

            <img src="assets/minimalist-basic/h02-2.jpg" style="border-radius:500px;margin-right: 1.5em">

            <img src="assets/minimalist-basic/h02-3.jpg" style="border-radius:500px">
...
<div data-num="25" data-thumb="assets/minimalist-basic/thumbnails/o01.png" data-cat="0,12">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <img src="assets/minimalist-basic/o01-1.jpg">
...
<div data-num="27" data-thumb="{{ asset('bstrapper/assets/minimalist-basic/thumbnails/k02.png') }}" data-cat="0,9">
        ...
        @foreach (blog_data() as $value)
            <div class="col-md-4">
                ...
                <figure>
                    ...
                    <img src="{{ asset('bstrapper/assets/minimalist-basic/k02-1.jpg') }}">
    ...
    @if ($total > $limit)
        <div class="mt-3 text-center">
            <a href="{{ url('blog') }}" class="btn btn-primary">Lihat Selengkapnya</a>
        </div>
    @endif
...
<div data-num="42" data-thumb="assets/minimalist-basic/thumbnails/r03.png" data-cat="0,15">
    ...
    <div class="row">
        ...
        <div class="col-md-6 center">
            ...
            <img src="assets/minimalist-basic/r03-1.jpg" style="border-radius:500px;margin-top:1.5em">
...
<div data-num="43" data-thumb="assets/minimalist-basic/thumbnails/r04.png" data-cat="0,15">
    ...
    <div class="row">
        ...
        <div class="col-md-6 center">
            ...
            <img src="assets/minimalist-basic/r04-1.jpg" style="border-radius:500px;margin-top:1.5em">
...
<div data-num="44" data-thumb="assets/minimalist-basic/thumbnails/s01.png" data-cat="0,16">
    ...
    <div class="row">
        ...
        <div class="col-md-2 center">
            ...
            <p><img src="assets/minimalist-basic/s01-1.jpg" style="border-radius:500px;margin-top:5px;"></p>
...
<div data-num="45" data-thumb="assets/minimalist-basic/thumbnails/s03.png" data-cat="0,16">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <img src="assets/minimalist-basic/s03-1.jpg">
        ...
        <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-4 center">
                    ...
                    <p><img src="assets/minimalist-basic/s10-1.jpg" style="border-radius:500px;margin-top:10px;"></p>
        ...
        <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-4 center">
                    ...
                    <p><img src="assets/minimalist-basic/s10-2.jpg" style="border-radius:500px;margin-top:10px;"></p>
...
<div data-num="55" data-thumb="assets/minimalist-basic/thumbnails/p34.png" data-cat="0,13">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <img src="assets/minimalist-basic/p34-1.png">
        ...
        <div class="col-md-6">
            ...
            <div style="margin:1.3em 0 2.5em;">
                ...
                <a href="#" class="btn btn-primary btn-lg" style="border-radius: 50px;">Read More</a>
...
<div data-num="59" data-thumb="assets/minimalist-basic/thumbnails/p42.png" data-cat="0,13">
    <div class="row">
        <div class="col-md-12">
            <img src="assets/minimalist-basic/p42-1.jpg">
    ...
    <div class="row">
        <div class="col-md-12">
            <div style="margin:0.5em 0 2.5em;">
                <a href="#" class="btn btn-default btn-lg" style="border-radius:50px">Read More</a> &nbsp;
                <a href="#" class="btn btn-primary btn-lg" style="border-radius:50px">Download</a>
            </div>
        </div>
    </div>
</div>
...
<div data-num="60" data-thumb="assets/minimalist-basic/thumbnails/p43.png" data-cat="0,13">
    ...
    <div class="row">
        <div class="col-md-12">
            <div style="margin:1em 0;">
                <a href="#" class="btn btn-primary btn-lg" style="border-radius:50px">GET STARTED</a>
            </div>
        </div>
    </div>
</div>
...
<div data-num="63" data-thumb="assets/minimalist-basic/thumbnails/p47.png" data-cat="0,13">
    ...
    <div class="row">
        <div class="col-md-12 center">
            <div style="margin:1em 0 2.5em;">
                <a href="#" class="btn btn-primary btn-lg" style="border-radius:50px">GET STARTED TODAY</a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 center">
            <div class="clearfix is-rounded-button-big">
                <a href="#" class="btn btn-default btn-lg" style="padding:0; width:80px; height:80px;"><i class="icon ion-android-arrow-dropright"></i> </a>
            </div>
        </div>
    </div>
</div>
...
<div data-num="65" data-thumb="assets/minimalist-basic/thumbnails/q20.png" data-cat="14">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <img src="assets/minimalist-basic/q20-1.png">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="padding-20">
                <img src="assets/minimalist-basic/q21-1.jpg" style="border-radius:500px">
                <br><br>
                <div class="list">
        ...
        <div class="col-md-4">
            <div class="padding-20">
                <img src="assets/minimalist-basic/q21-2.jpg" style="border-radius:500px">
                <br><br>
                <div class="list">
        ...
        <div class="col-md-4">
            <div class="padding-20">
                <img src="assets/minimalist-basic/q21-3.jpg" style="border-radius:500px">
                <br><br>
                <div class="list">
...
<div data-num="69" data-thumb="assets/minimalist-basic/thumbnails/q26.png" data-cat="14">
    ...
    <div class="row">
        <div class="col-md-6">
            <img src="assets/minimalist-basic/q26-1.jpg">
            <div class="list">
                <i class="icon ion-checkmark"></i>
                <h3>Feature Item</h3>
        ...
        <div class="col-md-6">
            <img src="assets/minimalist-basic/q26-2.jpg">
            <div class="list">
                <i class="icon ion-checkmark"></i>
                <h3>Feature Item</h3>
                <p>Lorem Ipsum is simply dummy text of the typesetting industry.</p>
...
<div data-num="74" data-thumb="assets/minimalist-basic/thumbnails/r23.png" data-cat="0,15">
    ...
    <div class="row">
        ...
        <div class="col-md-4 center">
            <div class="padding-20">
                <img src="assets/minimalist-basic/r23-1.jpg" style="border-radius: 500px;">
        ...
        <div class="col-md-4 center">
            <div class="padding-20">
                <img src="assets/minimalist-basic/r23-2.jpg" style="border-radius: 500px;">
        ...
        <div class="col-md-4 center">
            <div class="padding-20">
                <img src="assets/minimalist-basic/r23-3.jpg" style="border-radius: 500px;">
...
<div data-num="75" data-thumb="assets/minimalist-basic/thumbnails/r25.png" data-cat="0,15">
    ...
    <div class="row">
        <div class="col-md-6 center">
            <img src="assets/minimalist-basic/r25-1.jpg" style="border-radius: 500px;" alt="">
            <br>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
            <p><b>Your Name, </b>Lorem Ipsum</p>
        </div>
        ...
        <div class="col-md-6 center">
            <img src="assets/minimalist-basic/r25-2.jpg" style="border-radius: 500px;" alt="">
            <br>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
            <p><b>Your Name, </b>Lorem Ipsum</p>
        </div>
...
<div data-num="77" data-thumb="assets/minimalist-basic/thumbnails/r28.png" data-cat="0,15">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-4">
                    <img src="assets/minimalist-basic/r28-1.jpg" style="border-radius: 500px;" alt="">
                </div>
                <div class="col-md-8">
        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-4">
                    <img src="assets/minimalist-basic/r28-2.jpg" style="border-radius: 500px;" alt="">
                </div>
                <div class="col-md-8">
                    <p style="font-size:1.2em"><i>"Lorem ipsum dolor sit amet, adipiscing elit. Vivamus leo ante."</i></p>
                    <p><b><i>By Your Name</i></b></p>
...
<div data-num="85" data-thumb="assets/minimalist-basic/thumbnails/w04.png" data-cat="0,21">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <img src="assets/minimalist-basic/w04-1.png">
...
<div data-num="86" data-thumb="assets/minimalist-basic/thumbnails/w05.png" data-cat="21">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <img src="assets/minimalist-basic/w05-1.png">
...
<div data-num="95" data-thumb="assets/minimalist-basic/thumbnails/x12.png" data-cat="0,22">
    ...
    <div class="row">
        <div class="col-md-6">
            <img src="assets/minimalist-basic/x12-1.jpg" style="margin-top: 0px;">
        </div>
        ...
        <div class="col-md-4 center">
            <div class="padding-20">
                ...
                <div style="margin:2em 0">
                    ...
                    <a href="#" class="btn btn-primary btn-lg" style="border-radius: 50px">Purchase</a>
        ...
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-25 center">
                    ...
                    <p>Lorem Ipsum is simply dummy text. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
                    <div style="margin:2em 0">
                        <a href="#" class="btn btn-primary btn-lg" style="border-radius:50px">Buy Now</a>
                    </div>
                </div>
            </div>
        </div>
...
<div data-num="103" data-thumb="assets/minimalist-basic/thumbnails/y08.png" data-cat="0,23">
    ...
    <div class="row">
        <div class="col-md-4 center">
            ...
            <p>Lorem Ipsum is simply dummy text. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
            <div style="margin:2em 0">
                <a href="#" class="btn btn-primary btn-lg" style="border-radius:50px">Select Plan</a>
            </div>
        </div>
...
<div data-num="106" data-thumb="assets/minimalist-basic/thumbnails/z01.png" data-cat="0,24">
    ...
    <div class="row">
        ...
        <div class="col-md-4 center">
            ...
            <img src="assets/minimalist-basic/z01-1.jpg" style="border-radius:500px; margin-top: 1em">
    ...
    <div class="row">
        ...
        <div class="col-md-4 center">
            ...
            <img src="assets/minimalist-basic/z01-2.jpg" style="border-radius:500px; margin-top: 1em">
...
<div data-num="107" data-thumb="assets/minimalist-basic/thumbnails/z02.png" data-cat="0,24">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-4 center">
                    <img src="assets/minimalist-basic/z02-2.jpg" style="border-radius:500px">
                </div>
                <div class="col-md-8">
        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-4 center">
                    <img src="assets/minimalist-basic/z02-3.jpg" style="border-radius:500px">
                </div>
                <div class="col-md-8">
                    <p><b>Your Name</b><br>Lorem Ipsum is simply.</p>
                    <div class="is-social">
...
<div data-num="108" data-thumb="assets/minimalist-basic/thumbnails/z03.png" data-cat="0,24">
    ...
    <div class="row">
        ...
        <div class="col-md-6 center">
            <div class="padding-20">
                <img src="assets/minimalist-basic/z03-1.jpg" style="border-radius:500px">
        ...
        <div class="col-md-6 center">
            <div class="padding-20">
                <img src="assets/minimalist-basic/z03-2.jpg" style="border-radius:500px">
...
<div data-num="109" data-thumb="assets/minimalist-basic/thumbnails/z05.png" data-cat="0,24">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-25 center">
                    <img src="assets/minimalist-basic/z05-1.jpg" style="border-radius: 500px;" alt="">
        ...
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-25 center">
                    <img src="assets/minimalist-basic/z05-2.jpg" style="border-radius: 500px;" alt="">
                    <h3 style="font-size:1.5em">Your Name</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    <div class="is-social" style="margin:2em 0">
                        <a href="https://twitter.com/"><i class="icon ion-social-twitter" style="margin-right: 1em"></i></a>
        ...
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-25 center">
                    <img src="assets/minimalist-basic/z05-3.jpg" style="border-radius: 500px;" alt="">
                    <h3 style="font-size:1.5em">Your Name</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    <div class="is-social" style="margin:2em 0">
                        <a href="https://twitter.com/"><i class="icon ion-social-twitter" style="margin-right: 1em"></i></a>
...
<div data-num="110" data-thumb="assets/minimalist-basic/thumbnails/z06.png" data-cat="0,24">
    ...
    <div class="row">
        <div class="col-md-3 center">
            <img src="assets/minimalist-basic/z06-1.jpg" style="border-radius: 500px;" alt="">
            <p><b>Your Name</b><br>Lorem Ipsum is simply.</p>
            <div class="is-social">
                <a href="https://twitter.com/"><i class="icon ion-social-twitter" style="margin-right: 1em"></i></a>
                <a href="https://www.facebook.com/"><i class="icon ion-social-facebook" style="margin-right: 1em"></i></a>
        ...
        <div class="col-md-3 center">
            <img src="assets/minimalist-basic/z06-2.jpg" style="border-radius: 500px;" alt="">
            <p><b>Your Name</b><br>Lorem Ipsum is simply.</p>
            <div class="is-social">
                <a href="https://twitter.com/"><i class="icon ion-social-twitter" style="margin-right: 1em"></i></a>
                <a href="https://www.facebook.com/"><i class="icon ion-social-facebook" style="margin-right: 1em"></i></a>
        ...
        <div class="col-md-3 center">
            <img src="assets/minimalist-basic/z06-3.jpg" style="border-radius: 500px;" alt="">
            <p><b>Your Name</b><br>Lorem Ipsum is simply.</p>
            <div class="is-social">
                <a href="https://twitter.com/"><i class="icon ion-social-twitter" style="margin-right: 1em"></i></a>
                <a href="https://www.facebook.com/"><i class="icon ion-social-facebook" style="margin-right: 1em"></i></a>
        ...
        <div class="col-md-3 center">
            <img src="assets/minimalist-basic/z06-4.jpg" style="border-radius: 500px;" alt="">
            <p><b>Your Name</b><br>Lorem Ipsum is simply.</p>
            <div class="is-social">
                <a href="https://twitter.com/"><i class="icon ion-social-twitter" style="margin-right: 1em"></i></a>
                <a href="https://www.facebook.com/"><i class="icon ion-social-facebook" style="margin-right: 1em"></i></a>
...
<div data-num="111" data-thumb="assets/minimalist-basic/thumbnails/z07.png" data-cat="0,24">
    ...
    <div class="row">
        <div class="col-md-3 center">
            <img src="assets/minimalist-basic/z07-1.jpg" style="border-radius: 500px;">
        </div>
        ...
        <div class="col-md-3 center">
            <img src="assets/minimalist-basic/z07-2.jpg" style="border-radius: 500px;">
        </div>
...
<div data-num="112" data-thumb="assets/minimalist-basic/thumbnails/z09.png" data-cat="0,24">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-30 center">
                    <img src="assets/minimalist-basic/z09-1.jpg" style="border-radius: 500px;">
                    <h3 style="font-size:1.5em">Your Name</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
                    <div class="is-social" style="margin:2em 0">
                        <a href="https://twitter.com/"><i class="icon ion-social-twitter" style="margin-right: 1em"></i></a>
        ...
        <div class="col-md-6">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-30 center">
                    <img src="assets/minimalist-basic/z09-2.jpg" style="border-radius: 500px;">
                    <h3 style="font-size:1.5em">Your Name</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
                    <div class="is-social" style="margin:2em 0">
                        <a href="https://twitter.com/"><i class="icon ion-social-twitter" style="margin-right: 1em"></i></a>
...
<div data-num="113" data-thumb="assets/minimalist-basic/thumbnails/ab01.png" data-cat="0,25">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <img src="assets/minimalist-basic/ab01-1.jpg">

        </div>

        <div class="col-md-4">

            <img src="assets/minimalist-basic/ab01-2.jpg">

        </div>

        <div class="col-md-4">

            <img src="assets/minimalist-basic/ab01-3.jpg">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <img src="assets/minimalist-basic/ab01-4.jpg">

        </div>

        <div class="col-md-4">

            <img src="assets/minimalist-basic/ab01-5.jpg">

        </div>

        <div class="col-md-4">

            <img src="assets/minimalist-basic/ab01-6.jpg">
...
<div data-num="114" data-thumb="assets/minimalist-basic/thumbnails/ab02.png" data-cat="0,25">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="padding-20">
                <img src="assets/minimalist-basic/ab02-1.jpg">
        ...
        <div class="col-md-4">
            ...
            <div class="padding-20">
                <img src="assets/minimalist-basic/ab02-2.jpg">
        ...
        <div class="col-md-4">
            ...
            <div class="padding-20">
                <img src="assets/minimalist-basic/ab02-3.jpg">
...
<div data-num="115" data-thumb="assets/minimalist-basic/thumbnails/ab03.png" data-cat="25">
    ...
    <div class="row">
        ...
        <div class="col-md-4 center">
            <div class="padding-20">
                <img src="assets/minimalist-basic/ab03-1.jpg" style="border-radius: 500px">
        ...
        <div class="col-md-4 center">
            <div class="padding-20">
                <img src="assets/minimalist-basic/ab03-2.jpg" style="border-radius: 500px">
        ...
        <div class="col-md-4 center">
            <div class="padding-20">
                <img src="assets/minimalist-basic/ab03-3.jpg" style="border-radius: 500px">
...
<div data-num="116" data-thumb="assets/minimalist-basic/thumbnails/ab06.png" data-cat="0,25">
    ...
    <div class="row">
        <div class="col-md-12">
            <img src="assets/minimalist-basic/ab06-1.jpg"><img src="assets/minimalist-basic/ab06-2.jpg"><img src="assets/minimalist-basic/ab06-3.jpg">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div style="margin:1em 0 2.5em;">
                <a href="#" class="btn btn-primary btn-lg">VIEW PROJECT</a>
            </div>
        </div>
    </div>
</div>
...
<div data-num="117" data-thumb="assets/minimalist-basic/thumbnails/ab07.png" data-cat="0,25">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-25 center">
                    <img src="assets/minimalist-basic/ab07-1.jpg" style="border-radius: 500px">
        ...
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-25 center">
                    <img src="assets/minimalist-basic/ab07-2.jpg" style="border-radius: 500px">
        ...
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-25 center">
                    <img src="assets/minimalist-basic/ab07-3.jpg" style="border-radius: 500px">
...
<div data-num="118" data-thumb="assets/minimalist-basic/thumbnails/ab10.png" data-cat="0,25">
    ...
    <div class="row">
        <div class="col-md-6">
            <img src="assets/minimalist-basic/ab10-1.jpg">
        </div>
        <div class="col-md-6">
            <h1>Product One</h1>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <img src="assets/minimalist-basic/ab10-2.jpg">
        </div>
    </div>
</div>
        ...
        <div class="col-md-8">
            ...
            <div class="row">
                ...
                <div class="col-md-4 center">
                    ...
                    <img src="assets/minimalist-basic/ef01-1.png">
                ...
                <div class="col-md-4 center">
                    ...
                    <img src="assets/minimalist-basic/ef01-2.png">
                ...
                <div class="col-md-4 center">
                    ...
                    <img src="assets/minimalist-basic/ef01-3.png">
    ...
    <div class="row">
        ...
        <div class="col-md-12 center">
            ...
            <div class="center" style="display:inline-block;width:18%">
                ...
                <img src="assets/minimalist-basic/ef02-1.png">
            ...
            <div class="center" style="display:inline-block;width:18%">
                ...
                <img src="assets/minimalist-basic/ef02-2.png">
            ...
            <div class="center" style="display:inline-block;width:18%">
                ...
                <img src="assets/minimalist-basic/ef02-3.png">
            ...
            <div class="center" style="display:inline-block;width:18%">
                ...
                <img src="assets/minimalist-basic/ef02-4.png">
            ...
            <div class="center" style="display:inline-block;width:18%">
                ...
                <img src="assets/minimalist-basic/ef02-5.png">
...
<div data-num="129" data-thumb="assets/minimalist-basic/thumbnails/ef03.png" data-cat="0,27">
    ...
    <div class="row">
        ...
        <div class="col-md-3 center">
            ...
            <img src="assets/minimalist-basic/ef03-1.png">
        ...
        <div class="col-md-3 center">
            ...
            <img src="assets/minimalist-basic/ef03-2.png">
        ...
        <div class="col-md-3 center">
            ...
            <img src="assets/minimalist-basic/ef03-3.png">
        ...
        <div class="col-md-3 center">
            ...
            <img src="assets/minimalist-basic/ef03-4.png">
...
<div data-num="130" data-thumb="assets/minimalist-basic/thumbnails/ef05.png" data-cat="27">
    ...
    <div class="row">
        ...
        <div class="col-md-4 center">
            ...
            <img src="assets/minimalist-basic/ef05-1.png">
        ...
        <div class="col-md-4 center">
            ...
            <img src="assets/minimalist-basic/ef05-2.png">
        ...
        <div class="col-md-4 center">
            ...
            <img src="assets/minimalist-basic/ef05-3.png">
...
<div data-num="131" data-thumb="assets/minimalist-basic/thumbnails/ef08.png" data-cat="27">
    ...
    <div class="row">
        <div class="col-md-12 center">
            <div class="center" style="display:inline-block;width:18%">
                <img src="assets/minimalist-basic/ef08-1.png">
            </div>
            <div class="center" style="display:inline-block;width:18%">
                <img src="assets/minimalist-basic/ef08-2.png">
            </div>
            <div class="center" style="display:inline-block;width:18%">
                <img src="assets/minimalist-basic/ef08-3.png">
            </div>
            <div class="center" style="display:inline-block;width:18%">
                <img src="assets/minimalist-basic/ef08-4.png">
            </div>
            <div class="center" style="display:inline-block;width:18%">
                <img src="assets/minimalist-basic/ef08-5.png">
            </div>
        </div>
    </div>
</div>
...
<div data-num="132" data-thumb="assets/minimalist-basic/thumbnails/ef09.png" data-cat="0,27">
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-20 center">
                    <img src="assets/minimalist-basic/ef09-1.png">
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-20 center">
                    <img src="assets/minimalist-basic/ef09-2.png">
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-20 center">
                    <img src="assets/minimalist-basic/ef09-3.png">
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-20 center">
                    <img src="assets/minimalist-basic/ef09-4.png">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 center">
                    ...
                    <p style="line-height:1;margin-top:0">
                        <img src="assets/minimalist-basic/gh01-1.png">
                    </p>
        ...
        <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6 center">
                    ...
                    <p style="line-height:1;margin-top:0">
                        <img src="assets/minimalist-basic/gh01-2.png">
                    </p>
        ...
        <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6 center">
                    ...
                    <p style="line-height:1;margin-top:0">
                        <img src="assets/minimalist-basic/gh01-3.png">
                    </p>
...
<div data-num="134" data-thumb="assets/minimalist-basic/thumbnails/gh02.png" data-cat="0,28">
    ...
    <div class="row">
        ...
        <div class="col-md-3 center">
            ...
            <img src="assets/minimalist-basic/gh02-1.png">
        ...
        <div class="col-md-3 center">
            ...
            <img src="assets/minimalist-basic/gh02-2.png">
        ...
        <div class="col-md-3 center">
            ...
            <img src="assets/minimalist-basic/gh02-3.png">
        ...
        <div class="col-md-3 center">
            ...
            <img src="assets/minimalist-basic/gh02-4.png">
...
<div data-num="135" data-thumb="assets/minimalist-basic/thumbnails/gh03.png" data-cat="0,28">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-4">
                    <img src="assets/minimalist-basic/gh03-1.png">
                </div>
                <div class="col-md-8">
        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-4">
                    <img src="assets/minimalist-basic/gh03-2.png">
                </div>
                <div class="col-md-8">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-4">
                    <img src="assets/minimalist-basic/gh03-3.png">
                </div>
                <div class="col-md-8">
        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-4">
                    <img src="assets/minimalist-basic/gh03-4.png">
                </div>
                <div class="col-md-8">
                    <h3>Company Four</h3>
                </div>
...
<div data-num="136" data-thumb="assets/minimalist-basic/thumbnails/gh05.png" data-cat="28">
    ...
    <div class="row">
        ...
        <div class="col-md-4 center">
            <div class="padding-20">
                <img src="assets/minimalist-basic/gh05-1.png">
        ...
        <div class="col-md-4 center">
            <div class="padding-20">
                <img src="assets/minimalist-basic/gh05-2.png">
        ...
        <div class="col-md-4 center">
            <div class="padding-20">
                <img src="assets/minimalist-basic/gh05-3.png">
...
<div data-num="137" data-thumb="assets/minimalist-basic/thumbnails/gh07.png" data-cat="28">
    ...
    <div class="row">
        <div class="col-md-4">
            <img src="assets/minimalist-basic/gh07-1.png">
            <p>Lorem Ipsum is simply dummy text of the printing industry.</p>
        </div>

        <div class="col-md-4">
            <img src="assets/minimalist-basic/gh07-2.png">
            <p>Lorem Ipsum is simply dummy text of the printing industry.</p>
        </div>

        <div class="col-md-4">
            <img src="assets/minimalist-basic/gh07-3.png">
            <p>Lorem Ipsum is simply dummy text of the printing industry.</p>
        </div>
    </div>
</div>
...
<div data-num="138" data-thumb="assets/minimalist-basic/thumbnails/gh08.png" data-cat="0,28">
    ...
    <div class="row">
        <div class="col-md-6">
            <img src="assets/minimalist-basic/gh08-1.png">
            <h3 style="font-size:1.5em;margin-top:0">Company One</h3>
            <p>Lorem Ipsum is simply dummy text of the printing industry.</p>
        </div>

        <div class="col-md-6">
            <img src="assets/minimalist-basic/gh08-2.png">
    ...
    <div class="row">
        <div class="col-md-6">
            <img src="assets/minimalist-basic/gh08-3.png">
            <h3 style="font-size:1.5em;margin-top:0">Company Three</h3>
            <p>Lorem Ipsum is simply dummy text of the printing industry.</p>
        </div>

        <div class="col-md-6">
            <img src="assets/minimalist-basic/gh08-4.png">
...
<div data-num="139" data-thumb="assets/minimalist-basic/thumbnails/gh09.png" data-cat="0,28">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-25 center">
                    <img src="assets/minimalist-basic/gh09-1.png">
                    <h3>Company One</h3>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-25 center">
                    <img src="assets/minimalist-basic/gh09-2.png">
                    <h3>Company Two</h3>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-25 center">
                    <img src="assets/minimalist-basic/gh09-3.png">
                    <h3>Company Three</h3>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12 center">
            ...
            <div style="margin:1em 0 2.5em;">
                ...
                <a href="#" class="btn btn-primary btn-lg">GET UPDATES</a>
    ...
    <div class="row">
        ...
        <div class="col-md-12 center">
            ...
            <div style="margin:2em 0">
                ...
                <a href="#" class="btn btn-primary btn-lg" style="border-radius: 50px">GET UPDATES</a>
    ...
    <div class="row">
        ...
        <div class="col-md-12 center">
            ...
            <div>
                ...
                <a href="#" class="btn btn-primary btn-lg" style="border-radius: 50px">Get Notified</a>
    ...
    <div class="row">
        ...
        <div class="col-md-12 center">
            ...
            <div>
                ...
                <a href="#" class="btn btn-primary btn-lg" style="border-radius: 50px">Back to Home Page</a>
    ...
    <div class="row">
        ...
        <div class="col-md-12 center">
            ...
            <div style="margin:2em 0">
                ...
                <a href="#" class="btn btn-primary btn-lg" style="border-radius: 50px">BACK HOME</a>
...
<div data-num="175" data-thumb="assets/minimalist-basic/thumbnails/b17.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title1-48 is-title-lite size-48">LOREM IPSUM IS SIMPLY DUMMY TEXT</h1>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="176" data-thumb="assets/minimalist-basic/thumbnails/b18.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title1-32 is-title-lite size-32">LOREM IPSUM IS SIMPLY DUMMY TEXT OF THE PRINTING AND TYPESETTING INDUSTRY</h1>
            <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="177" data-thumb="assets/minimalist-basic/thumbnails/b19.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            ...
            <h1 class="is-title2-96 is-title-lite size-96">Lorem Ipsum</h1>
            <p class="size-24">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="178" data-thumb="assets/minimalist-basic/thumbnails/b20.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            ...
            <h1 class="is-title2-64 is-title-lite size-64">Lorem Ipsum</h1>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="179" data-thumb="assets/minimalist-basic/thumbnails/b21.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <i class="icon ion-ios-home-outline size-64" style="line-height:1"></i>
            <h1 class="is-title2-48 is-title-lite size-48">LOREM IPSUM IS SIMPLY DUMMY TEXT</h1>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="180" data-thumb="assets/minimalist-basic/thumbnails/b22.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            ...
            <h1 class="is-title2-32 is-title-lite size-32">LOREM IPSUM IS SIMPLY DUMMY TEXT OF THE PRINTING AND TYPESETTING INDUSTRY</h1>
            <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="181" data-thumb="assets/minimalist-basic/thumbnails/b23.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title3-96 is-title-lite size-96">Lorem Ipsum</h1>
            <p class="size-24">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="182" data-thumb="assets/minimalist-basic/thumbnails/b24.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title3-64 is-title-lite size-64">Lorem Ipsum</h1>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="183" data-thumb="assets/minimalist-basic/thumbnails/b25.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title3-48 is-title-lite size-48">LOREM IPSUM IS SIMPLY DUMMY TEXT</h1>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="184" data-thumb="assets/minimalist-basic/thumbnails/b26.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title3-32 is-title-lite size-32">LOREM IPSUM IS SIMPLY DUMMY TEXT OF THE PRINTING AND TYPESETTING INDUSTRY</h1>
            <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="185" data-thumb="assets/minimalist-basic/thumbnails/b27.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <div>
                <h1 class="is-title4-96 is-title-lite size-96" style="display:inline-block">Lorem Ipsum</h1>
            </div>
            <p class="size-24">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
...
<div data-num="186" data-thumb="assets/minimalist-basic/thumbnails/b28.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <div>
                <h1 class="is-title4-64 is-title-lite size-64" style="display:inline-block">Lorem Ipsum</h1>
            </div>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
...
<div data-num="187" data-thumb="assets/minimalist-basic/thumbnails/b29.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <div>
                <h1 class="is-title4-48 is-title-lite size-48" style="display:inline-block">LOREM IPSUM IS DUMMY TEXT</h1>
            </div>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
...
<div data-num="188" data-thumb="assets/minimalist-basic/thumbnails/b30.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <div>
                <h1 class="is-title4-32 is-title-lite size-32" style="display:inline-block">LOREM IPSUM IS SIMPLY DUMMY TEXT OF THE PRINTING AND TYPESETTING INDUSTRY</h1>
            </div>
            <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
...
<div data-num="189" data-thumb="assets/minimalist-basic/thumbnails/b31.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title5-96 is-title-lite size-96">Lorem Ipsum</h1>
            <p class="size-24">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="190" data-thumb="assets/minimalist-basic/thumbnails/b32.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title5-64 is-title-lite size-64">Lorem Ipsum</h1>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="191" data-thumb="assets/minimalist-basic/thumbnails/b33.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title5-48 is-title-lite size-48">LOREM IPSUM IS SIMPLY DUMMY TEXT</h1>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="192" data-thumb="assets/minimalist-basic/thumbnails/b34.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title5-32 is-title-lite size-32">LOREM IPSUM IS SIMPLY DUMMY TEXT OF THE PRINTING AND TYPESETTING INDUSTRY</h1>
            <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="195" data-thumb="assets/minimalist-basic/thumbnails/b37.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title1-48 is-title-bold size-48">LOREM IPSUM IS SIMPLY DUMMY TEXT</h1>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="196" data-thumb="assets/minimalist-basic/thumbnails/b38.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title1-32 is-title-bold size-32">LOREM IPSUM IS SIMPLY DUMMY TEXT OF THE PRINTING AND TYPESETTING INDUSTRY</h1>
            <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="197" data-thumb="assets/minimalist-basic/thumbnails/b39.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <i class="icon ion-ios-home-outline size-96" style="line-height:1"></i>
            <h1 class="is-title2-96 is-title-bold size-96">Lorem Ipsum</h1>
            <p class="size-24">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="198" data-thumb="assets/minimalist-basic/thumbnails/b40.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <i class="icon ion-ios-home-outline size-96" style="line-height:1"></i>
            <h1 class="is-title2-64 is-title-bold size-64">Lorem Ipsum</h1>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="199" data-thumb="assets/minimalist-basic/thumbnails/b41.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <i class="icon ion-ios-home-outline size-64" style="line-height:1"></i>
            <h1 class="is-title2-48 is-title-bold size-48">LOREM IPSUM IS SIMPLY DUMMY TEXT</h1>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="200" data-thumb="assets/minimalist-basic/thumbnails/b42.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <i class="icon ion-ios-home-outline size-48" style="line-height:1"></i>
            <h1 class="is-title2-32 is-title-bold size-32">LOREM IPSUM IS SIMPLY DUMMY TEXT OF THE PRINTING AND TYPESETTING INDUSTRY</h1>
            <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="201" data-thumb="assets/minimalist-basic/thumbnails/b43.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title3-96 is-title-bold size-96">Lorem Ipsum</h1>
            <p class="size-24">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="202" data-thumb="assets/minimalist-basic/thumbnails/b44.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title3-64 is-title-bold size-64">Lorem Ipsum</h1>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="203" data-thumb="assets/minimalist-basic/thumbnails/b45.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title3-48 is-title-bold size-48">LOREM IPSUM IS SIMPLY DUMMY TEXT</h1>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="204" data-thumb="assets/minimalist-basic/thumbnails/b46.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title3-32 is-title-bold size-32">LOREM IPSUM IS SIMPLY DUMMY TEXT OF THE PRINTING AND TYPESETTING INDUSTRY</h1>
            <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="205" data-thumb="assets/minimalist-basic/thumbnails/b47.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <div>
                <h1 class="is-title4-96 is-title-bold size-96" style="display:inline-block">Lorem Ipsum</h1>
            </div>
            <p class="size-24">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
...
<div data-num="206" data-thumb="assets/minimalist-basic/thumbnails/b48.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <div>
                <h1 class="is-title4-64 is-title-bold size-64" style="display:inline-block">Lorem Ipsum</h1>
            </div>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
...
<div data-num="207" data-thumb="assets/minimalist-basic/thumbnails/b49.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <div>
                <h1 class="is-title4-48 is-title-bold size-48" style="display:inline-block">LOREM IPSUM IS DUMMY TEXT</h1>
            </div>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
...
<div data-num="208" data-thumb="assets/minimalist-basic/thumbnails/b50.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <div>
                <h1 class="is-title4-32 is-title-bold size-32" style="display:inline-block">LOREM IPSUM IS SIMPLY DUMMY TEXT OF THE PRINTING AND TYPESETTING INDUSTRY</h1>
            </div>
            <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
...
<div data-num="209" data-thumb="assets/minimalist-basic/thumbnails/b51.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title5-96 is-title-bold size-96">Lorem Ipsum</h1>
            <p class="size-24">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="210" data-thumb="assets/minimalist-basic/thumbnails/b52.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title5-64 is-title-bold size-64">Lorem Ipsum</h1>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="211" data-thumb="assets/minimalist-basic/thumbnails/b53.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title5-48 is-title-bold size-48">LOREM IPSUM IS SIMPLY DUMMY TEXT</h1>
            <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="212" data-thumb="assets/minimalist-basic/thumbnails/b54.png" data-cat="2">
    <div class="row">
        <div class="col-md-12">
            <h1 class="is-title5-32 is-title-bold size-32">LOREM IPSUM IS SIMPLY DUMMY TEXT OF THE PRINTING AND TYPESETTING INDUSTRY</h1>
            <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
    </div>
</div>
...
<div data-num="213" data-thumb="assets/minimalist-basic/thumbnails/c02.png" data-cat="3">
    <div class="row">
        <div class="col-md-12">
            <p class="is-info1 size-24">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
            <h1 class="is-title1-96 is-title-lite size-96">Lorem Ipsum</h1>
        </div>
    </div>
</div>
...
<div data-num="217" data-thumb="assets/minimalist-basic/thumbnails/c06.png" data-cat="3">
    <div class="row">
        <div class="col-md-12">
            <i class="icon ion-ios-home-outline size-96" style="line-height:1"></i>
            <p class="is-info1 size-24">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
            <h1 class="is-title2-96 is-title-lite size-96">Lorem Ipsum</h1>
        </div>
    </div>
</div>
...
<div data-num="233" data-thumb="assets/minimalist-basic/thumbnails/c22.png" data-cat="3">
    <div class="row">
        <div class="col-md-12">
            <p class="is-info2 size-24">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
            <h1 class="is-title1-96 is-title-bold size-96">Lorem Ipsum</h1>
        </div>
    </div>
</div>
...
<div data-num="237" data-thumb="assets/minimalist-basic/thumbnails/c26.png" data-cat="3">
    <div class="row">
        <div class="col-md-12">
            <i class="icon ion-ios-home-outline size-96" style="line-height:1"></i>
            <p class="is-info2 size-24">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
            <h1 class="is-title2-96 is-title-bold size-96">Lorem Ipsum</h1>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-25 center">
                    <img src="assets/minimalist-basic/z05-1.jpg" style="border-radius: 500px;" alt="">
                    <h3 class="is-title1-28 is-title-lite size-28">LOREM IPSUM </h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    <div class="is-social" style="margin:2em 0">
                        <a href="https://twitter.com/"><i class="icon ion-social-twitter" style="margin-right: 1em"></i></a>
                        <a href="https://www.facebook.com/"><i class="icon ion-social-facebook" style="margin-right: 1em"></i></a>
...
<div data-num="266" data-thumb="assets/minimalist-basic/thumbnails/de02.png" data-cat="34">
    <div class="row">
        <div class="col-md-6">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-30 center">
                    <img src="assets/minimalist-basic/k06-1.jpg" style="border-radius: 500px;" alt="">
                    <h3 class="is-title1-32 is-title-lite size-32">LOREM IPSUM </h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
                    <div class="is-social" style="margin:2em 0">
                        <a href="https://twitter.com/"><i class="icon ion-social-twitter" style="margin-right: 1em"></i></a>
                        <a href="https://www.facebook.com/"><i class="icon ion-social-facebook" style="margin-right: 1em"></i></a>
        ...
        <div class="col-md-6">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-30 center">
                    <img src="assets/minimalist-basic/k06-2.jpg" style="border-radius: 500px;" alt="">
                    <h3 class="is-title1-32 is-title-lite size-32">LOREM IPSUM </h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
                    <div class="is-social" style="margin:2em 0">
                        <a href="https://twitter.com/"><i class="icon ion-social-twitter" style="margin-right: 1em"></i></a>
        ...
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-25 center">
                    ...
                    <h3 class="is-title1-28 is-title-bold size-28">LOREM IPSUM</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                </div>
            </div>
        </div>
            ...
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-25 center">
                    ...
                    <div style="margin:2em 0 1em">
                        <a href="#" class="is-btn is-btn-small is-btn-ghost1 is-upper">Read More</a>
                    </div>
                </div>
            </div>
        </div>
...
<div data-num="280" data-thumb="assets/minimalist-basic/thumbnails/de16.png" data-cat="34">
    <div class="row">
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <img src="assets/minimalist-basic/p02-1.jpg" class="margin-0" alt="">
                <div class="margin-25">
                    <h3 class="margin-0 is-title-lite size-28">LOREM IPSUM</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
...
<div data-num="281" data-thumb="assets/minimalist-basic/thumbnails/de17.png" data-cat="34">
    <div class="row">
        <div class="col-md-6">
            <div class="is-card max-390 is-dark-text shadow-1">
                <img src="assets/minimalist-basic/g03-1.jpg" class="margin-0" alt="">
                <div class="margin-30">
                    <h3 class="margin-0 is-title-lite size-28">LOREM IPSUM</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    <div style="margin:2em 0 0.5em">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <img src="assets/minimalist-basic/p02-1.jpg" class="margin-0" alt="">
                <div class="margin-25">
                    <h3 class="margin-0 is-title-bold size-28">LOREM IPSUM</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    <div style="margin:2em 0 0.5em">
                        <a href="#" class="is-btn is-btn-small is-btn-ghost1 is-upper">Read More</a>
                    </div>
        ...
        <div class="col-md-12">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-40 center">
                    ...
                    <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    <div style="margin:2em 0 0.5em">
                        <a href="#" class="is-btn is-btn-ghost1 is-upper">Read More</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-40 center">
                    ...
                    <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    <div style="margin:2em 0 0.5em">
                        <a href="#" class="is-btn is-btn-small is-btn-ghost2 is-upper">Read More</a> &nbsp;
                        <a href="#" class="is-btn is-btn-small is-btn-ghost1 is-upper">Buy Now</a>
                    </div>
                </div>
            </div>
        </div>
...
<div data-num="290" data-thumb="assets/minimalist-basic/thumbnails/de26.png" data-cat="34">
    <div class="row">
        <div class="col-md-12">
            <div class="is-card is-dark-text shadow-1">
                <div class="margin-40 center">
                    <h1 class="is-title1-48 is-title-bold size-48">LOREM IPSUM IS DUMMY TEXT</h1>
                    <p class="size-21">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    <div style="margin:2em 0 0.5em">
                        <a href="#" class="is-btn is-btn-ghost2 is-upper">Read More</a> &nbsp;
                        <a href="#" class="is-btn is-btn-ghost1 is-upper">Buy Now</a>
...
<div data-num="294" data-thumb="assets/minimalist-basic/thumbnails/de30.png" data-cat="34">
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <img src="assets/minimalist-basic/de01-1.jpg" class="margin-0" alt="">
                <div class="margin-25">
                    <h3 class="margin-0 is-title-lite size-28">LOREM IPSUM</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        ...
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <img src="assets/minimalist-basic/de01-2.jpg" class="margin-0" alt="">
                <div class="margin-25">
                    <h3 class="margin-0 is-title-lite size-28">LOREM IPSUM</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    <div class="is-social" style="margin:2em 0 0.5em">
        ...
        <div class="col-md-4">
            <div class="is-card is-dark-text shadow-1">
                <img src="assets/minimalist-basic/de01-3.jpg" class="margin-0" alt="">
                <div class="margin-25">
                    <h3 class="margin-0 is-title-lite size-28">LOREM IPSUM</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    <div class="is-social" style="margin:2em 0 0.5em">
...
<div data-num="295" data-thumb="assets/minimalist-basic/thumbnails/de31.png" data-cat="34">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="is-card max-390 is-dark-text shadow-1">
                <img src="assets/minimalist-basic/de02-1.jpg" class="margin-0" alt="">
                <div class="margin-30">
                    <h3 class="margin-0 is-title-lite size-28">LOREM IPSUM</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    <div class="is-social" style="margin:2em 0 0.5em">
        ...
        <div class="col-md-6">
            <div class="is-card max-390 is-dark-text shadow-1">
                <img src="assets/minimalist-basic/de02-2.jpg" class="margin-0" alt="">
                <div class="margin-30">
                    <h3 class="margin-0 is-title-lite size-28">LOREM IPSUM</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    <div class="is-social" style="margin:2em 0 0.5em">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="is-card is-card-circle is-dark-text shadow-1">
                <div class="is-card-content-centered">
                    <h1 class="is-title1-32 is-title-lite size-32">LOREM IPSUM IS DUMMY TEXT</h1>
                    <p>Lorem Ipsum is simply dummy text of the printing industry.</p>
                    <div style="margin:1.2em 0 0">
                        <a href="#" class="is-btn is-btn-ghost1 is-upper is-btn-small">Read More</a>
                    </div>
                </div>
            </div>
        </div>
...
<div data-num="298" data-thumb="assets/minimalist-basic/thumbnails/de34.png" data-cat="34">
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="is-card is-card-circle is-dark-text shadow-1">
                <div class="is-card-content-centered">
                    <h1 class="is-title1-32 is-title-bold size-32">LOREM IPSUM IS DUMMY TEXT</h1>
                    <p>Lorem Ipsum is simply dummy text of the printing industry.</p>
                    <div style="margin:1.2em 0 0">
                        <a href="#" class="is-btn is-btn-ghost1 is-upper is-btn-small">Read More</a>
                    </div>
