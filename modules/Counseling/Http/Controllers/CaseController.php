...
use Modules\Counseling\Http\Requests\Cases\StoreRequest;
use Modules\Counseling\Http\Requests\Cases\UpdateRequest;
...
class CaseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        })->whereHas('employee')->whereHas('semester', function ($semester) {
