<ul class="metismenu list-unstyled" id="side-menu">
    ...
    <li class="nav-main-item">
        ...
        <ul class="sub-menu mm-collapse">
            <li>
                <a class="nav-main-link" href="{{ route('counseling::presences.create') }}"><i class="nav-icon bx bxs-duplicate"></i> presensi pagi</a>
            </li>

            <li>
                <a class="nav-main-link" href="{{ route('counseling::presences.index') }}"><i class="nav-icon bx bxs-duplicate"></i> presensi mapel</a>
            </li>
        </ul>
    </li>
