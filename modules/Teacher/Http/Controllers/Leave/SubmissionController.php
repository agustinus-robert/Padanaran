...
namespace Modules\Teacher\Http\Controllers\Leave;
...
use Modules\Boarding\Http\Requests\Leaves\Submission\StoreRequest;
	...
	//	$student = $request->user()->student;
        ...
        foreach ($steps as $step) {
			...
			foreach ($expectedPositionIds as $expectedPositionId) {
				...
				return redirect()->route('teacher::leave.manage.index')->with('success', isset($position) ? 'Pengajuan izin sudah terkirim, silakan tunggu notifikasi selanjutnya dari atasan!' : 'Pengajuan sudah tersimpan dan sudah disetujui otomatis oleh sistem, terima kasih!');
			}
