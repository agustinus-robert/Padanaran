...
class MutationVehcileDatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->rawColumns(['file_sk','detail','date_mutation','information']);
     ...
     */
    public function query(MutationVehcile $model)
    {
    ...
    {
        return $this->builder()
                    ->setTableId('mutation-vehcile-table')
