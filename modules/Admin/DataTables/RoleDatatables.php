    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                 $template = '';
                 $template .= view('admin::layouts_master.component.button_edit', array('id' => $row->id, 'update' => route('admin::builder.role.edit', ['role' => $row->id])))->render();
                 $template .= view('admin::layouts_master.component.button_delete', array('id' => $row->id, 'delete' => route('admin::builder.role.destroy', ['role' => $row->id])))->render();
                 return $template;
             })
            ->rawColumns(['action'])
            ->addIndexColumn();
