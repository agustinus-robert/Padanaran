...
class RoomDatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('building', function($row){
                return Building::find($row->building_id)->name;
            })
            ->addColumn('name', function($row){
                return $row->name;
            })
            ->addColumn('floor', function($row){
                return Floor::find($row->floor_id)->name;
            })
            ->addColumn('information', function($row){
                return $row->information;
            })
            ->rawColumns(['building', 'name', 'floor', 'information']);
