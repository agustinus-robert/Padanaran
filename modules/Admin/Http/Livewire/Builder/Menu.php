...
use Modules\Admin\Models\Menu as MData;
...
class Menu extends Component
{
    ...
    public function mount(Request $req){
       ...
       $this->menu_category = DB::table('categoryzation_menu')->where(['deleted_at' => null])->get()->toArray();
       $this->list_menu = DB::table('menu')->where(['deleted_at' => null])->get()->toArray();
        ...
        if(empty($this->title)){
         ...
         //   dd($arr_save);
            if($this->data_id){
                ...
                MData::where('id', $this->data_id)->update($arr_save);
    ...
    {
        return view('admin::livewire.builder.menu');
    }
}
