...
use Modules\Admin\Repositories\EmployeePositionRepository;
use Modules\Admin\Http\Requests\Employment\Position\StoreRequest;
use Modules\Admin\Http\Requests\Employment\Position\UpdateRequest;
...
class PositionController extends Controller
{
    ...
    public function create(EmployeeContract $contract, Request $request)
    {
        ...
        return view('admin::employment.positions.create', compact('contract', 'departments'));
    }
    ...
    public function edit(EmployeePosition $position, Request $request)
    {
        ...
        return view('admin::employment.positions.edit', compact('departments', 'position'));
    }
