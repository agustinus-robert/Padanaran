...
@if(str_contains(url()->full(), 'create') || str_contains(url()->full(), 'edit'))
	 @livewire('admin::builder.role')
@else
	<div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
		<!--begin::Page title-->
		<div class="page-title d-flex flex-column me-3">
			<!--begin::Title-->
			<h1 class="d-flex text-gray-900 fw-bold my-1 fs-3">Role</h1>
			<!--end::Title-->
			<!--begin::Breadcrumb-->
		                ...
		                <div class="row no-gutters align-items-center">
		                    <div class="col mr-2">
		                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
		                            Total Role</div>
		                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?=count($get_role)?></div>
		                    </div>
		                    <div class="col-auto">
		...
		<div class="card card-flush">
			...
			<div class="card-header align-items-center py-5 gap-2 gap-md-5">
				...
				<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
					<!--begin::Add product-->
					<a href="{{route('admin::builder.role.create')}}" class="btn btn-primary"> Add Menu</a>
					<!--end::Add product-->
				</div>
				
		    </div>
		    <div class="card-body">          
		         @livewire('admin::datatables.role-datatable') 
		    </div>
		</div>
	</div>
@endif
