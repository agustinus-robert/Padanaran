...
@if(str_contains(url()->full(), 'create') || str_contains(url()->full(), 'edit'))
	@livewire('admin::builder.posting-video')
@else
	<div>
		<main>
			...
			@endif
			    ...
			    <div class="card shadow-none border my-4">
			        <div class="card-header p-4 border-bottom bg-body">
			            <div class="row g-3 justify-content-between align-items-center">
			                ...
			                <div class="col col-md-auto">
			                    <a class="btn btn-sm btn-phoenix-primary ms-2" href="<?=route('admin::builder.posting_video.create')?>?id_menu={{$id_menu}}&post_id={{$post_id}}">
			        ...
			        <div class="card-body">          
			            @livewire('admin::datatables.posting-video-datatable') 
			        </div>
			    </div>
			</div>
		</main>
