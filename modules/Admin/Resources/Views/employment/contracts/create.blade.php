    ...
    <div class="row justify-content-center">
        <div class="col-xxl-8 col-xl-10">
            <div class="d-flex align-items-center mb-4">
                <a class="text-decoration-none" href="{{ request('next', route('admin::employment.contracts.index')) }}"><i class="mdi mdi-arrow-left-circle-outline mdi-36px"></i></a>
                <div class="ms-4">
            ...
            <div class="card mb-4 border-0">
                <div class="card-body">
                    <form class="form-block" action="{{ route('admin::employment.contracts.store', ['next' => request('next')]) }}" method="POST" enctype="multipart/form-data"> @csrf
                        <div class="row required mb-3">
                            <label class="col-lg-4 col-xl-3 col-form-label">Nama karyawan</label>
                            <div class="col-xl-8 col-xxl-6">
                                <select class="@error('employee_id') is-invalid @enderror form-select" name="employee_id" required>
                                    @isset($employee)
                        ...
                        <div class="row required mb-3">
                            ...
                            <div class="col-xl-6 col-xxl-5">
                                <select class="@error('contract_id') is-invalid @enderror form-select" name="contract_id" required>
        ...
        document.addEventListener("DOMContentLoaded", async () => {
            new TomSelect('[name="employee_id"]', {
                ...
                load: function(q, callback) {
                    fetch('{{ route('api::admin.employees.search') }}?q=' + encodeURIComponent(q))
