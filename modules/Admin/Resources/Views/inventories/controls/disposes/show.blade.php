    ...
    <div class="col-xxl-8 col-xl-8">
        ...
        <div class="card border-0">
            ...
            <div class="card-body border-top">
                <form class="form-block" action="{{ route('asset::inventories.controls.restocks.update', ['item' => $item->id, 'next' => request('next', route('asset::inventories.controls.restocks.index'))]) }}" method="POST" enctype="multipart/form-data"> @csrf
                    <div class="mb-3">
