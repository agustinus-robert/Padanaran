                          ...
                          $('#pagelist').val(page_info.page);
                                ...
                                var trash = "{{$trash}}"
                                    if(trash == 1){
                                        ...
                                        return '<button class="btn btn-sm btn-warning" wire:click="$dispatch(\'tool-sell-edited\', { id: '+row.id+'})"><i class="fa fa-pencil" aria-hidden="true"></i></button>'+
                                    '<button class="btn btn-sm btn-danger" wire:click="$dispatch(\'tool-sell-delete\', { id: '+row.id+'})"><i class="fa fa-trash" aria-hidden="true"></i></button>';    
                                    }
                            }
