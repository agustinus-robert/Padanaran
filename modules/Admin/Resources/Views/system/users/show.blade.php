            ...
            <div class="card border-0">
                <div class="card-body text-center">
                    <ul class="nav nav-pills">
                        <li class="nav-item"> <a class="nav-link @if (request('page') == 'profile') active text-dark bg-light @endif" href="{{ route('admin::system.users.show', ['user' => $user->id, 'page' => 'profile', 'next' => request('next')]) }}">Profil</a> </li>
                        <li class="nav-item"> <a class="nav-link @if (request('page') == 'username') active text-dark bg-light @endif" href="{{ route('admin::system.users.show', ['user' => $user->id, 'page' => 'username', 'next' => request('next')]) }}">Username</a> </li>
                        <li class="nav-item"> <a class="nav-link @if (request('page') == 'email') active text-dark bg-light @endif" href="{{ route('admin::system.users.show', ['user' => $user->id, 'page' => 'email', 'next' => request('next')]) }}">Alamat surel</a> </li>
                        <li class="nav-item"> <a class="nav-link @if (request('page') == 'phone') active text-dark bg-light @endif" href="{{ route('admin::system.users.show', ['user' => $user->id, 'page' => 'phone', 'next' => request('next')]) }}">Nomor ponsel</a> </li>
                        <li class="nav-item"> <a class="nav-link @if (request('page') == 'role') active text-dark bg-light @endif" href="{{ route('admin::system.users.show', ['user' => $user->id, 'page' => 'role', 'next' => request('next')]) }}">Peran</a> </li>
                    </ul>
                </div>
                <div class="card-body border-top">
                    ...
                    @if (request('page') == 'username')
                        <form class="form-block" action="{{ route('admin::system.users.update.username', ['user' => $user->id]) }}" method="POST"> @csrf @method('PUT')
                            <div class="row">
                    ...
                    @if (request('page') == 'email')
                        <form class="form-block" action="{{ route('admin::system.users.update.email', ['user' => $user->id]) }}" method="POST"> @csrf @method('PUT')
                            <div class="row">
                                <div class="col-md-10 col-lg-8">
                    ...
                    @if (request('page') == 'phone')
                        <form class="form-block" action="{{ route('admin::system.users.update.phone', ['user' => $user->id]) }}" method="POST"> @csrf @method('PUT')
                            <div class="row">
                                <div class="col-md-10 col-lg-8">
                    ...
                    @if (request('page') == 'role')
                        <form class="form-block" action="{{ route('admin::system.users.update.role', ['user' => $user->id]) }}" method="POST"> @csrf @method('PUT')
                            <div class="row">
                                <div class="col-md-10 col-lg-8">
                                    @include('x-admin::System.User.Role.form', ['user' => $user, 'roles' => $roles])
                                </div>
                            </div>
                        </form>
                    @endif
