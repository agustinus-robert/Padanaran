        ...
        <div class="col-xl-4">
            ...
            <div class="card border-0">
                <div class="card-body d-flex justify-content-between align-items-center flex-row py-4">
                    <div>
                        <div class="display-4">{{ $employee_count ?? 0 }}</div>
                ...
                <div class="list-group list-group-flush border-top">
                    <a class="list-group-item list-group-item-action text-dark" href="{{ route('finance::summary.coords.create') }}"><i class="mdi mdi-plus"></i> Tambah potongan</a>
                </div>
            </div>
            <div class="card border-0">
                <div class="card-body">
