...
@push('additional-content')
    ...
    <div class="card mb-3">
        <div class="card-header pb-0 p-3">
            <h6 class="mb-0 d-flex align-items-center">
                <i class="material-symbols-rounded me-2">filter_alt</i> Filter Laporan Cuti
            </h6>
        </div>
        <div class="card-body p-3">
            <form action="{{ route('hrms::report.vacations.index') }}" method="get">
                {{-- Periode --}}
                <div class="mb-3">
                    <label class="form-label text-xs font-weight-bold">Periode Cuti</label>
                    <x-date-range-select />
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center gap-2">
                    ...
                    <a class="btn btn-light btn-sm mb-0" 
                       href="{{ route('hrms::report.vacations.index', ['start_at' => $start_at->format('Y-m-d'), 'end_at' => $end_at->format('Y-m-d')]) }}" 
                       title="Reset">
    ...
    <div class="card mb-3">
        <div class="card-header pb-0 p-3">
            <h6 class="mb-0 d-flex align-items-center">
                <i class="material-symbols-rounded me-2">event_note</i> Ekspor Laporan
            </h6>
        </div>
        <div class="card-body p-3 pt-0">
            <div class="list-group list-group-flush">
                <button type="button" 
                    ...
                    <i class="material-symbols-rounded me-2 text-success">file_download</i> Unduh Rekap Data Cuti (Excel)
                </button>
            </div>
            ...
            <div class="bg-gray-100 border-radius-lg p-2">
                <p class="text-xxs text-muted mb-0 italic" style="line-height: 1.4;">
                    Data diambil berdasarkan rentang: <br>
