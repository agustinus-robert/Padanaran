...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-sm-12">
            ...
            @php($approvable = $scheduleSubmission->approvables->last())
            {{-- @foreach ($scheduleSubmission->approvables->last() as $approvable) --}}
            <div class="row gy-2">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    @if ($approvable->userable->is($employee->position) && !$scheduleSubmission->trashed())
                        <form class="form-block" action="{{ route('portal::schedule-teacher.submissionappr.update', ['approvable' => $approvable->id, 'next' => request('next', route('administration::service.submission.index'))]) }}" method="post"> @csrf @method('PUT')
