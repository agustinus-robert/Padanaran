...
@section('title', 'Rekap baru | ')
@section('navtitle', 'Rekap baru')
    ...
    <div class="row justify-content-center">
        <div class="col-xxl-8 col-xl-10">
            <div class="d-flex align-items-center mb-4">
                ...
                <div class="ms-4">
                    <h2 class="mb-1">Rekap baru</h2>
                    <div class="text-secondary">Silakan isi daftar nama murid yang dikoordinir pada formulir di bawah ini untuk ditampikan pada selip gaji guru </div>
                </div>
            </div>
            <div class="card mb-4 border-0">
                <div class="card-body">
                    <a href="javascript:void(0)" id="addition" class="btn btn-danger mb-4">+ Tambah Murid</a>
