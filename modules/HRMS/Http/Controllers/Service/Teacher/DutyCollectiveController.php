...
class CollectiveController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('hrms::service.schedules_teacher.manage.dutycollective.create', compact('user', 'employees', 'employee_count', 'month', 'workshifts', 'calendarData', 'type', 'databaseResult', 'label'));
    }
