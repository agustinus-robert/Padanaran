...
namespace Modules\Administration\Http\Controllers\Service;
...
class ScanlogController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('administration::services.scanlogs.index', compact('start_at', 'end_at', 'departments', 'scanlogs', 'locations'));
    }
