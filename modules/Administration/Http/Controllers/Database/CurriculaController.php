...
namespace Modules\Administration\Http\Controllers\Database;

use Illuminate\Http\Request;
use Modules\Administration\Http\Controllers\Controller;
use Auth;
use Modules\Administration\Models\SchoolCurricula;
use Modules\Administration\Http\Requests\Database\Curricula\StoreRequest;
use Modules\Administration\Http\Requests\Database\Curricula\UpdateRequest;
