                ...
                <div class="card-body">
                    <form class="form-block" action="{{ route('administration::scholar.classrooms.store', ['semester_id' => $acsem->id, 'next' => request('next', route('administration::scholar.classrooms.index', ['academic' => request('academic', $acsem->id)]))]) }}" method="POST"> @csrf
                        ...
                        <div class="form-group required row mb-3">
                            ...
                            <div class="col-md-5">
                                <select class="form-control select-2 @error('level_id') is-invalid @enderror" name="level_id" id="level_id">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-7">
                                <select class="form-control select-2 @error('room_id') is-invalid @enderror" name="room_id" id="room_id">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-7">
                                <select class="form-control select-2 @error('major_id') is-invalid @enderror" name="major_id" id="major_id">
                                    <option value="">-- Pilih jurusan --</option>
                                    @foreach ($acsem->majors->where('grade_id', userGrades()) as $major)
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-7">
                                <select class="form-control select-2 @error('superior_id') is-invalid @enderror" name="superior_id" id="superior_id">
                                    <option value="">-- Pilih unggulan --</option>
                                    @foreach ($acsem->superiors->where('grade_id', userGrades()) as $superior)
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-control select-2 @error('supervisor_id') is-invalid @enderror" name="supervisor_id" id="supervisor_id">
                                    <option value="">-- Pilih wali kelas --</option>
                                    @foreach ($supervisors as $supervisor)
                                        <option value="{{ $supervisor->id }}" @if (old('supervisor_id') == $supervisor->id) selected @endif>{{ $supervisor->user->name }}</option>
                                    @endforeach
                                </select>
                                @error('supervisor_id')
                                    <small class="invalid-feedback"> {{ $message }} </small>
