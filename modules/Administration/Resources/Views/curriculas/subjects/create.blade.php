                ...
                <div class="card-body">
                    <form class="form-block" action="{{ route('administration::curriculas.subjects.store', ['semester_id' => $acsem->id, 'next' => request('next', route('administration::curriculas.subjects.index', ['academic' => request('academic', $acsem->id)]))]) }}" method="POST"> @csrf
                        ...
                        <div class="form-group required row mb-3">
                            ...
                            <div class="col-md-4">
                                <input type="number" name="score_standard" class="form-control @error('score_standard') is-invalid @enderror" id="score_standard" placeholder="Nilai KKM" value="{{ old('score_standard') }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-7">
                                <input type="color" name="color_id"  value="#ffffff" />
                                @error('color_id')
                                    <small class="invalid-feedback"> {{ $message }} </small>
                                @enderror
                            </div>
